			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						Selamat Datang, <?php if($h=='1'){ ?>Admin<?php }?><?php if($h=='2'){ ?>Pemilik<?php }?><?php if($h=='3'){ ?>Penjahit<?php }?>!
						
						<span class="pull-right clickable panel-toggle panel-button-tab-left"><em class="fa fa-toggle-up"></em></span></div>
					<div class="panel-body">
						<div class="canvas-wrapper">			
							<p>Selamat Datang di Sistem Informasi Produksi dan Pencatatan Penjualan di Silva Fashion</p>
						</div>
					</div>
				</div>
			</div>
