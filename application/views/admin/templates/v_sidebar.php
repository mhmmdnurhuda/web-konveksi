	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <?php if($h=='1'){ ?> 
			...
			<li><a href="<?php echo base_url().'admin/pembelianbaru'?>"><em class="fa fa-shopping-cart">&nbsp;</em> Pembelian Bahan</a></li>
			<!--<li><a href="<?php echo base_url().'admin/pembeliankain'?>"><em class="fa fa-shopping-cart">&nbsp;</em> Pembelian Kain</a></li>-->
