		...
		<div class="row">
            ...
            <table class="table table-bordered " id="">
				...
				<!-- 	<tr>
                        ...
                        <td style="vertical-align:middle;">Laporan Data Stok Kain</td>
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-primary" href="<?php echo base_url().'admin/daftarlaporan/laporan_stok_kain'?>" target="_blank" data-toggle="modal"><span class="fa fa-print"></span> Cetak</a>
                        </td>
                    </tr> -->
					
					<tr>
                        <td style="text-align:center;vertical-align:middle">1</td>
                        <td style="vertical-align:middle;">Laporan Data Stok Baju</td>
                        <td style="text-align:center;">
