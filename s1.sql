...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2019 at 09:58 AM
...
--
-- Table structure for table `t_belikain`
--
...
--
-- Dumping data for table `t_belikain`
--
...
--
-- Table structure for table `t_belikain_detail`
--
...
--
-- Dumping data for table `t_belikain_detail`
--
...
--
-- Table structure for table `t_jualproduk`
--
...
--
-- Dumping data for table `t_jualproduk`
--
...
--
-- Table structure for table `t_jualproduk_detail`
--
...
--
-- Dumping data for table `t_jualproduk_detail`
--
...
--
-- Table structure for table `t_kain_warna`
--
...
--
-- Dumping data for table `t_kain_warna`
--
...
--
-- Table structure for table `t_produkbaju`
--
...
--
-- Dumping data for table `t_produkbaju`
--
...
--
-- Table structure for table `t_rencanabaru`
--
...
--
-- Dumping data for table `t_rencanabaru`
--
...
--
-- Table structure for table `t_rencanabaru_detail`
--
...
--
-- Dumping data for table `t_rencanabaru_detail`
--
...
--
-- AUTO_INCREMENT for table `t_belikain_detail`
--
ALTER TABLE `t_belikain_detail`
  MODIFY `d_beli_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `t_jualproduk_detail`
--
ALTER TABLE `t_jualproduk_detail`
  MODIFY `d_jual_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `t_rencanabaru_detail`
--
ALTER TABLE `t_rencanabaru_detail`
